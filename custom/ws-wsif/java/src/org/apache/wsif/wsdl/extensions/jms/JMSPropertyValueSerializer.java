...
public class JMSPropertyValueSerializer
    ...
    public void marshall(
        ...
        JMSPropertyValue jmsPropertyValue = (JMSPropertyValue) extension;
        String tagName =
            DOMUtils.getQualifiedValue(JMSConstants.NS_URI_JMS, "propertyValue", def);
        pw.print("      <" + tagName);
        ...
        if (jmsPropertyValue.getName() != null) {
            DOMUtils.printAttribute(JMSConstants.ATTR_NAME, jmsPropertyValue.getName(), pw);
        }

        if (jmsPropertyValue.getType() != null) {
            DOMUtils.printQualifiedAttribute(
                JMSConstants.ATTR_TYPE,
                jmsPropertyValue.getType(),
                def,
                pw);
        }
    ...
    public void registerSerializer(ExtensionRegistry registry) {
        ...
        registry.registerSerializer(
           ...
           JmsBindingConstants.Q_ELEM_JMS_PROPERTY_VALUE,
           this);
        registry.registerDeserializer(
           javax.wsdl.BindingOutput.class,
           JmsBindingConstants.Q_ELEM_JMS_PROPERTY_VALUE,
    ...
    public ExtensibilityElement unmarshall(
        ...
        JMSPropertyValue jmsPropertyValue =
            (JMSPropertyValue) extReg.createExtension(parentType, elementType);

        String name = DOMUtils.getAttribute(el, JMSConstants.ATTR_NAME);
        if (name != null) {
            jmsPropertyValue.setName(name);
        }
        ...
        if (value != null) {
            jmsPropertyValue.setValue(value);
        }
