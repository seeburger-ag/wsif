...
public class JMSOutputSerializer
    ...
    public void marshall(
        ...
        String tagName =
            DOMUtils.getQualifiedValue(JMSConstants.NS_URI_JMS, "output", def);
        pw.print("      <" + tagName);
        ...
        if (jmsOutput.getParts() != null) {
            DOMUtils.printAttribute(
                ...
                com.ibm.wsdl.util.StringUtils.getNMTokens(jmsOutput.getParts()),
                pw);
        }

        if (jmsOutput.getSchema() != null) {
            DOMUtils.printAttribute(JMSConstants.ATTR_SCHEMA, jmsOutput.getSchema(), pw);
        }
    ...
    public void registerSerializer(ExtensionRegistry registry) {
        ...
        registry.registerSerializer(
            ...
            JMSConstants.Q_ELEM_JMS_OUTPUT,
            this);
    ...
    public ExtensibilityElement unmarshall(
        ...
        JMSOutput jmsOutput =
            (JMSOutput) extReg.createExtension(parentType, elementType);
        String parts = DOMUtils.getAttribute(el, JMSConstants.ATTR_PARTS);
        if (parts != null) {
            jmsOutput.setParts(com.ibm.wsdl.util.StringUtils.parseNMTokens(parts));
        }
