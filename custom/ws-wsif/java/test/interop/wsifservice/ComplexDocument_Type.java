...
public class ComplexDocument_Type  implements java.io.Serializable {
    private interop.wsifservice.ArrayOfSimpleDocument simpleDoc;
    private interop.wsifservice.ChildDocument child;
    private java.lang.String anAttribute;  // attribute

    public ComplexDocument_Type() {
    }

    public interop.wsifservice.ArrayOfSimpleDocument getSimpleDoc() {
        return simpleDoc;
    }

    public void setSimpleDoc(interop.wsifservice.ArrayOfSimpleDocument simpleDoc) {
        this.simpleDoc = simpleDoc;
    }

    public interop.wsifservice.ChildDocument getChild() {
        return child;
    }

    public void setChild(interop.wsifservice.ChildDocument child) {
        this.child = child;
    }
