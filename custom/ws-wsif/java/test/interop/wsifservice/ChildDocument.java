...
public class ChildDocument  implements java.io.Serializable {
    private interop.wsifservice.ArrayOfSimpleDocument childSimpleDoc;

    public ChildDocument() {
    }

    public interop.wsifservice.ArrayOfSimpleDocument getChildSimpleDoc() {
        return childSimpleDoc;
    }

    public void setChildSimpleDoc(interop.wsifservice.ArrayOfSimpleDocument childSimpleDoc) {
