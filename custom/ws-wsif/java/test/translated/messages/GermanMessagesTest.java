 ...
 */
public class GermanMessagesTest extends TestCase {
    public GermanMessagesTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(GermanMessagesTest.class);
    }
    ...
    public void testGerman() {
        TranslatedMessagesUtilities.doit(Locale.GERMAN);
    }
}
