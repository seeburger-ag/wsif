 ...
 */
public class FrenchMessagesTest extends TestCase {
    public FrenchMessagesTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(FrenchMessagesTest.class);
    }
    ...
    public void testFrench() {
        TranslatedMessagesUtilities.doit(Locale.FRENCH);
    }
