 ...
 */
public class ItalianMessagesTest extends TestCase {
    public ItalianMessagesTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(ItalianMessagesTest.class);
    }
    ...
    public void testItalian() {
        TranslatedMessagesUtilities.doit(Locale.ITALIAN);
    }
}
