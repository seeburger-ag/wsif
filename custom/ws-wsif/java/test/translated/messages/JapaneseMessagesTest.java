 ...
 */
public class JapaneseMessagesTest extends TestCase {
    public JapaneseMessagesTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(JapaneseMessagesTest.class);
    }
    ...
    public void testJapanese() {
        TranslatedMessagesUtilities.doit(Locale.JAPANESE);
    }
}
