 ...
 */
public class BrazilianMessagesTest extends TestCase {
    public BrazilianMessagesTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(BrazilianMessagesTest.class);
    }

    public void setUp() {
    }

    public void testBrazilian() {
//        TranslatedMessagesUtilities.doit(Locale.BRAZILIAN);
    }
