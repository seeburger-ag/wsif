 ...
 */
public class KoreanMessagesTest extends TestCase {
    public KoreanMessagesTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(KoreanMessagesTest.class);
    }
...
//        TranslatedMessagesUtilities.doit(Locale.KOREAN);
    }
