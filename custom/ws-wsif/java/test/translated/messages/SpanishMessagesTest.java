 ...
 */
public class SpanishMessagesTest extends TestCase {
    public SpanishMessagesTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(SpanishMessagesTest.class);
    }
...
//        TranslatedMessagesUtilities.doit(Locale.SPANISH);
    }
}
