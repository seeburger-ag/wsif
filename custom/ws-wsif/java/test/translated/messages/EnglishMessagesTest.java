 ...
 */
public class EnglishMessagesTest extends TestCase {
    public EnglishMessagesTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(EnglishMessagesTest.class);
    }
    ...
    public void testEnglish() {
        TranslatedMessagesUtilities.doit(Locale.ENGLISH);
    }
