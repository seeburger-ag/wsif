 ...
 */
public class ChineseMessagesTest extends TestCase {
    public ChineseMessagesTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(ChineseMessagesTest.class);
    }
    ...
    public void testChinese() {
        TranslatedMessagesUtilities.doit(Locale.CHINESE);
    }
}
